...
base_deps="brotli-libs libssh2 nghttp2 libidn2 krb5 libpsl zstd"
...
build_debian:
	./create_dev_image.sh ${arch} ${debian_base} ${compiler} \
	  "git zsh curl gcc libtool autoconf automake make perl libssl-dev libssh2-1 libssh2-1-dev libnghttp2-dev libbrotli-dev libzstd-dev libidn2-dev libkrb5-dev libpsl-dev cargo python3-pip python3-dev stunnel nghttp2" \
